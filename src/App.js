    ...
    return ( <main className="App">
      ...
      <section className="Content">
        <Switch>
          ...
          <Route path="/note/:noteId" folders={folders} render={( { match, history } ) => {
              const selectedNote = this.props.store.notes.find( n => n.id === match.params.noteId );

              console.log( folders );
              const folderName = folders.find( folder => selectedNote.folderId === folder.id );
